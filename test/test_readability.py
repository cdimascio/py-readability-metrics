...
class ReadabilityTest(unittest.TestCase):
    ...
    def test_ari(self):
        ...
        print(r)
        self.assertEqual(9.551245421245422, r.raw_score)
    ...
    def test_smog(self):
        ...
        self.assertEqual(12.516099999999998, r1.raw_score)
        self.assertEqual('13', r1.grade_level)

        self.assertEqual(12.785403640627713, r2.raw_score)
    ...
    def test_spache(self):
        ...
        print(r)
        self.assertEqual(7.164945054945054, r.raw_score)
